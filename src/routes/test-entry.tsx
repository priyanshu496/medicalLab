...
import { AlertCircle, FileText, Home, Search, X } from 'lucide-react';
...
export const Route = createFileRoute('/test-entry')({
  component: TestEntry,
});
      ...
      <header className="bg-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 bg-linear-to-br from-teal-600 to-cyan-500 rounded-lg flex items-center justify-center shadow-md">
              <FileText className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Test Entry</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            {showResults ? 'Search Results' : 'Patients Ready for Test Entry'}
          </h3>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => navigate({ to: `/test-entry/${patient.id}` })}
                        className="bg-linear-to-r from-teal-600 to-cyan-500 hover:from-teal-700 hover:to-cyan-600 gap-2"
                      >
